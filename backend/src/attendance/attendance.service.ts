...
export class AttendanceService {
    ...
    async create(createAttendanceDto: CreateAttendanceDto): Promise<Attendance> {
        ...
        if (existingAttendance) {
            throw new BadRequestException('Attendance record already exists for this student and course on this date');
        }
    ...
    async recordAttendance(recordAttendanceDto: RecordAttendanceDto): Promise<Attendance> {
        ...
        const attendance = this.attendanceRepository.create({
            ...
            location: recordAttendanceDto.location,
            device_info: recordAttendanceDto.device_info,
        });
